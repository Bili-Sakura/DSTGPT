...
Conguratulation! 
You have started the DST-GPT! 
Try to chat with DST-GPT!
...
**设置GUI界面，输入api_key并选择基模型**

**设置GUI界面，用户自定义大模型温度、提示词模板、非领域大模型**
